...
function Logger:new (o)
    ...
    o._DEFAULT_OUTPUT_FORMAT     = "%s [%s] -- %s\n"
    o._DEFAULT_FILE_NAME_FORMAT  = "%s_%s.log"    
    o._DEFAULT_DATE_FORMAT       = "%Y%m%d%H%M%S"

    o._DEFAULT_FILE_POINTER      = io.stdio
    o._DEFAULT_FILE_NAME         = nil
    o._DEFAULT_FILE_PATH         = nil 
    o._DEFAULT_MAX_FILES         = 0
    
    o._currentMaxNumberOfFIles   = o._DEFAULT_MAX_FILES
    o._currentFilePointer        = o._DEFAULT_FILE_POINTER
    o._currentFilePath           = o._DEFAULT_FILE_PATH
    o._currentFileName           = o._DEFAULT_FILE_NAME
    o._currentLogLevel           = o.logLevels.INFO
    o._currentOutputFormat       = o._DEFAULT_OUTPUT_FORMAT
    o._currentFileNameFormat     = o._DEFAULT_FILE_NAME_FORMAT
    o._currentLogMaxSize         = 2097152 -- 2MB

    o._write_on_c4_logfile       = false
    return o
end
