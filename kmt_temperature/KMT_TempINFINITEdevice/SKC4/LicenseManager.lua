...
function LicenseManager:new(o)
    ...
    setmetatable(o, self)
    self.__index = self
    o.currentVendorId = "DRIVERCENTRAL"
    o.statusMessage = ""
    o.vendorData = {
        DRIVERCENTRAL 	= { 
    ...
    o.houselogixTimerCheck = {}
    o.houselogixTimerTrial = {}    

    o.OnPropertyChangedTable = {}
    o.OnPropertyChangedTable["License Provider"]        = LicenseManager.SKC4_ON_PROPERTY_CHANGED_LicenseProvider
    o.OnPropertyChangedTable["Houselogix License Code"] = LicenseManager.SKC4_ON_PROPERTY_CHANGED_HouselogixLicenseCode
    o.OnPropertyChangedTable["SoftKiwi License Code"]   = LicenseManager.SKC4_ON_PROPERTY_CHANGED_SoftKiwiLicenseCode
...
function LicenseManager:OnPropertyChanged(strName)
    ...
    if (self.OnPropertyChangedTable[strName]) then
        status, err = pcall(self.OnPropertyChangedTable[strName], self, propertyValue)
        if (not status) then
